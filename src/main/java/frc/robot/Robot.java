...
public class Robot extends TimedRobot {
  ...
  public static OI getMainOI() {
    return mainOI;
  }

  public static SubsystemDriveBase getDriveBase() {
    return driveBase;
  }
  ...
  public void autonomousInit() {
    mainAutonomousCommand = mainChooser.getSelected();
    ...
    if (mainAutonomousCommand != null) {
      mainAutonomousCommand.start();
    }
  }
